  ...
  return (
    <div className="min-h-screen bg-slate-100/60 p-4 sm:p-6 print:bg-white print:p-0">
      ...
      <div className="print-document a4-single-page mx-auto max-w-4xl bg-white p-3 sm:p-4 text-slate-900 shadow-md border border-slate-200 rounded-lg print:border-0 print:shadow-none print:p-0 print:rounded-none text-[9.5px] leading-tight">
        ...
        {/* Se modo for 'complete', renderiza seções separadas de Produtos e Serviços */}
        {mode === 'complete' && (
          <>
            {/* DUAS SEÇÕES INDEPENDENTES: PRODUTOS E SERVIÇOS */}
            <div className="page-break-inside-avoid mb-2 space-y-2">
              ...
              {(() => {
                ...
                const subProds = prods.reduce(
                  (sum, it) =>
                    sum + (Number(it.valor_unitario) || 0) * (Number(it.quantidade) || 0),
                  0,
                )
                return (
                    ...
                    <table className="w-full border-collapse text-[9.5px]">
                      <thead>
                        <tr className="bg-indigo-50/60 text-slate-700 border-b border-indigo-100">
                          ...
                          <th className="px-1.5 py-0.5 text-left font-bold">
                      ...
                      <tbody className="divide-y divide-slate-100">
                        {prods.length > 0 ? (
                          ...
                          <tr>
                            <td
                              colSpan={6}
                              className="px-1.5 py-1 text-center text-slate-400 italic"
                            >
                        ...
                        {servs.length > 0 ? (
                          ...
                          <tr>
                            <td
                              ...
                              className="px-1.5 py-1 text-center text-slate-400 italic"
                            >
                              Nenhum serviço incluído neste orçamento.
                            </td>
                          </tr>
                        )}
                      </tbody>
              ...
              {/* RESUMO FINANCEIRO COMPLETO (PRODUTOS + SERVIÇOS - DESCONTOS = TOTAL GERAL) */}
              {(() => {
                  ...
                  <div className="mt-1 flex justify-end">
                    <div className="w-72 space-y-0.5 rounded bg-slate-50 p-2 border border-slate-300 text-right text-[10px]">
                      ...
                      <div className="flex justify-between text-slate-600 pt-0.5 border-t border-slate-200">
                        <span>Subtotal Bruto Total:</span>
